...
static lv_obj_t *address_button(lv_obj_t *root, device_t device) {
    ...
    switch (device.class) {
        ...
        case DEVICE_CLASS_PRESSURE_SAFETY(DEVICE_GROUP_4):
        case DEVICE_CLASS_PRESSURE_SAFETY(DEVICE_GROUP_5):
        case DEVICE_CLASS_PRESSURE_SAFETY(DEVICE_GROUP_6):
        ...
        case DEVICE_CLASS_PRESSURE_TEMPERATURE_HUMIDITY_SAFETY(DEVICE_GROUP_4):
        case DEVICE_CLASS_PRESSURE_TEMPERATURE_HUMIDITY_SAFETY(DEVICE_GROUP_5):
        case DEVICE_CLASS_PRESSURE_TEMPERATURE_HUMIDITY_SAFETY(DEVICE_GROUP_6):
